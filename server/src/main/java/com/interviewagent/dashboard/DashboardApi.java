...
public final class DashboardApi {
    ...
    public record Activity(String type, String title, String detail, String targetPath, OffsetDateTime occurredAt) {}
    public record WeaknessFocus(String tag, int count, String targetPath) {}
